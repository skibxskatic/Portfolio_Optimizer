...
def generate_test_pdf():
    ...
    with io.StringIO() as f:
        ...
        f.write("> **Test Run:** This report uses mock data to test the PDF layout and CSS styling.\n\n")

        # --- Section 1: High-Level Metrics ---
        f.write("## 1. High-Level Metrics\n")
        f.write("- **Weighted Average Expense Ratio:** `0.080%`\n")
        f.write("  - ✅ *Excellent: Your portfolio fees are highly optimized.*\n")
        f.write("- **Risk-Free Rate (13-Week T-Bill):** `4.50%` *(mocked)*\n")
