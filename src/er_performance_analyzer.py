...
def analyze_tradeoffs():
    ...
    tickers = [
        ...
        "VYM",
        "VIG",
        "FDVV",  # Dividend / Value (Low-to-Mid ER)
        "JEPI",
        "JEPQ",
        "DGRW",
        "NOBL",  # Smart Beta / Covered Call (Mid-to-High ER)
        "SPY",
        "QQQ",
        "VTI",  # Broad Market (Ultra-Low ER)
        "ARKK",
        "FBGRX",
        "FNCMX",  # Active Growth / Thematic (High ER)
        "FELG",
        "FTEC",  # Fidelity specific
    ]
